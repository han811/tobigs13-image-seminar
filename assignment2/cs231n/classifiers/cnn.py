...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        # Hidden affine layer
        # cnn 은 convolution layer 후에도 넓이와 높이가 보존됨
        # 2*2 max pool makes the width and height reduce by half       
    ...
    def loss(self, X, y=None):
        ...
        score, scores_cache = affine_forward(affine_relu_out, W3, b3)
        ...
        define_relu_out, dW3, db3 = affine_backward(dscores, scores_cache)
