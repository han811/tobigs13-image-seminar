...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        fc, cache = affine_relu_forward(X, self.params['W1'], self.params['b1'])
        scores, cache_ = affine_forward(fc, self.params['W2'], self.params['b2'])
        ...
        # Compute grads
        dfc1, dW2, db2 = affine_backward(dscores, cache_)
        _, dW1, db1 = affine_relu_backward(dfc1, cache)
