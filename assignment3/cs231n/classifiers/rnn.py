...
class CaptioningRNN(object):
    ...
    def sample(self, features, max_length=30):
        ...
        # initializing hidden state of RNN
        hidden_state0 = np.dot(features, W_proj) + b_proj

        captions[:, 0] = self._start #start token
        
        prev_h = hidden_state0 #previous hidden state
        prev_c = np.zeros_like(hidden_state0)  #privious cell state
